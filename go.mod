...
// sigs.k8s.io/controller-runtime v0.23.3, but pins them back to v0.35.5 / v0.23.3
// via module-local replaces. Those replaces don't propagate, so we mirror them
// here to keep the k8s.io/api set consistent with the client-go informers keda
// was actually built against (v0.36.0 removed the autoscaling/v2beta1,
// autoscaling/v2beta2 and scheduling/v1alpha1 packages client-go still imports).
replace (
